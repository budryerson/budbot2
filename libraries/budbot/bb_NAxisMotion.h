...
// GPIO to reset the BNO055
// RESET pin has to be HIGH for the BNO055 to operate
#define RESET_PIN   4
// GPIO to receive Interrupt from BNO055
// INT_PIN is the interrupt number not the interrupt pin
// Interrupt is visible on the INT LED on the Shield
#if defined(__AVR_ATmega32U4__) // for Arduino Yun and Leonardo
  #define INT_PIN     4         
...
// Define which I2C bus is used.
#if defined(ARDUINO_SAM_DUE)
  #define I2C       Wire1   //  Wire1 for the Arduino Due
#else
...
class bb_NAxisMotion
{
  private:
    ...
    struct  bno055_linear_accel_float_t linearAccelData;
    struct  bno055_gravity_float_t   gravAccelData;      
    struct  bno055_calib_stat_t      calibStatus;
    struct  bno055_accel_stat_t      accelStatus;  
  ...
  public:
    ...
    *******************************************************************************************/
    ...
    /************************************************************
    * Description: Remap axis and sign to correct for IMU position
    * Set device to P0 position: Swap X/Y Axises and set X negative
    * Input Parameters: None
    * Return Parameter: None
    /*************************************************************/
    void remapAxisPosition();
